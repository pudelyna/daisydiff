...
public final class RangeDifferencer {
    ...
    public static RangeDifference[] findDifferences(IRangeComparator left,
        ...
        return findDifferences(new LCSSettings(), left, right);
    }
     ...
     * @since 2.0
     */
    public static RangeDifference[] findDifferences(LCSSettings settings, IRangeComparator ancestor,
                                                    IRangeComparator left, IRangeComparator right) {
        if (ancestor == null)
            return findDifferences(settings, left, right);
     ...
     * @since 2.0
     */
    public static RangeDifference[] findRanges(LCSSettings settings, IRangeComparator ancestor,
                                               IRangeComparator left, IRangeComparator right) {
